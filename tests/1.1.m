...
geti_save	mul r1, r1, r6	% Make sure the sign is correct.
			...
			jr r15
entry
addi r14, r0, 660  % Set the stack pointer
...
addi r1, r0, 0	% Storing 0
sb 19(r14), r1
lw r1, 16(r14)	% x=10 - loading 0 of 4
lw r2, 12(r14)
...
addi r1, r0, 255	% Storing 255
sb 35(r14), r1
lw r1, 28(r14)	% y=20.0 - loading 0 of 8
lw r2, 20(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
lw r1, 32(r14)	% y=20.0 - loading 4 of 8
lw r2, 20(r14)
...
sw 40(r14), r1	% Store the put value of x - storing 0 of 4
addi r14, r14, 36
jl r15, puti_func
subi r14, r14, 36
addi r1, r0, 4	% Start to calculate the offset for y
...
addi r1, r1, 4
sw 24(r14), r1
lw r1, 20(r14)	% Store the put value of y - loading 0 of 8
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 40(r14), r1	% Store the put value of y - storing 0 of 8
lw r1, 24(r14)	% Store the put value of y - loading 4 of 8
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 44(r14), r1	% Store the put value of y - storing 4 of 8
addi r14, r14, 36
jl r15, putf_func
subi r14, r14, 36
hlt
