...
geti_save	mul r1, r1, r6	% Make sure the sign is correct.
			...
			jr r15
entry
addi r14, r0, 668  % Set the stack pointer
addi r1, r0, 0	% Start to calculate the offset for obj
sw 8(r14), r1
addi r1, r1, 4
sw 12(r14), r1
addi r1, r0, 0	% Start to calculate the offset for value
sw 16(r14), r1
addi r1, r14, 0	% Calculating the REAL offset for obj.value
lw r2, 8(r14)
add r1, r1, r2
lw r2, 16(r14)
add r1, r1, r2
...
addi r1, r0, 0	% Storing 0
sb 27(r14), r1
lw r1, 24(r14)	% obj.value=10 - loading 0 of 4
lw r2, 20(r14)
...
addi r1, r1, 4
sw 12(r14), r1
addi r1, r0, 4	% Start to calculate the offset for otherValue
sw 28(r14), r1
addi r1, r14, 0	% Calculating the REAL offset for obj.otherValue
lw r2, 8(r14)
add r1, r1, r2
lw r2, 28(r14)
add r1, r1, r2
...
addi r1, r0, 0	% Storing 0
sb 39(r14), r1
lw r1, 36(r14)	% obj.otherValue=20 - loading 0 of 4
lw r2, 32(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
addi r1, r0, 0	% Start to calculate the offset for obj
sw 8(r14), r1
...
add r1, r1, r2
sw 20(r14), r1
lw r1, 20(r14)	% Store the put value of obj.value - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 44(r14), r1	% Store the put value of obj.value - storing 0 of 4
addi r14, r14, 40
jl r15, puti_func
subi r14, r14, 40
addi r1, r0, 0	% Start to calculate the offset for obj
...
add r1, r1, r2
sw 32(r14), r1
lw r1, 32(r14)	% Store the put value of obj.otherValue - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 44(r14), r1	% Store the put value of obj.otherValue - storing 0 of 4
addi r14, r14, 40
jl r15, puti_func
subi r14, r14, 40
hlt
