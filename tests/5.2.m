...
geti_save	mul r1, r1, r6	% Make sure the sign is correct.
			...
			jr r15
entry
addi r14, r0, 508  % Set the stack pointer
...
addi r1, r0, 0	% Storing 0
sb 11(r14), r1
lw r1, 8(r14)	% x=5 - loading 0 of 4
lw r2, 4(r14)
...
sw 20(r14), r1	% Store the put value of x - storing 0 of 4
addi r14, r14, 16
jl r15, puti_func
subi r14, r14, 16
...
addi r1, r0, 0	% Storing 0
sb 15(r14), r1
lw r1, 12(r14)	% Store the put value of 10 - loading 0 of 4
sw 20(r14), r1	% Store the put value of 10 - storing 0 of 4
addi r14, r14, 16
jl r15, puti_func
subi r14, r14, 16
hlt
