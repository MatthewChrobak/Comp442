...
geti_save	mul r1, r1, r6	% Make sure the sign is correct.
			...
			jr r15
entry
addi r14, r0, 436  % Set the stack pointer
addi r1, r0, 0	% Start to calculate the offset for data
sw 4(r14), r1
addi r1, r14, 0	% Calculating the REAL offset for data
lw r2, 4(r14)
add r1, r1, r2
sw 4(r14), r1
...
addi r1, r0, 0	% Storing 0
sb 11(r14), r1
lw r1, 8(r14)	% data=10 - loading 0 of 4
lw r2, 4(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
addi r1, r0, 0	% Start to calculate the offset for hack
addi r1, r14, 0	% Calculating the REAL offset for hack
lw r2, 12(r14)
add r1, r1, r2
addi r14, r14, 12
jl r15, puti_func
