...
geti_save	mul r1, r1, r6	% Make sure the sign is correct.
			...
			jr r15
entry
addi r14, r0, 996  % Set the stack pointer
...
addi r1, r0, 0	% Storing 0
sb 35(r14), r1
lw r1, 32(r14)	% object.x=10 - loading 0 of 4
lw r2, 28(r14)
...
addi r1, r0, 0	% Storing 0
sb 47(r14), r1
lw r1, 44(r14)	% object.y=20 - loading 0 of 4
lw r2, 40(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
addi r1, r0, 8	% Start to calculate the offset for otherObject
sw 48(r14), r1
addi r1, r1, 4
sw 52(r14), r1
addi r1, r0, 0	% Start to calculate the offset for x
...
addi r1, r0, 0	% Storing 0
sb 63(r14), r1
lw r1, 60(r14)	% otherObject.x=30 - loading 0 of 4
lw r2, 56(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
addi r1, r0, 8	% Start to calculate the offset for otherObject
sw 48(r14), r1
...
addi r1, r0, 0	% Storing 0
sb 71(r14), r1
lw r1, 68(r14)	% otherObject.y=40 - loading 0 of 4
lw r2, 64(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
addi r1, r0, 0	% Start to calculate the offset for object
sw 16(r14), r1
...
add r1, r1, r2
sw 28(r14), r1
lw r1, 28(r14)	% Store the put value of object.x - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 76(r14), r1	% Store the put value of object.x - storing 0 of 4
addi r14, r14, 72
jl r15, puti_func
subi r14, r14, 72
addi r1, r0, 0	% Start to calculate the offset for object
...
add r1, r1, r2
sw 40(r14), r1
lw r1, 40(r14)	% Store the put value of object.y - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 76(r14), r1	% Store the put value of object.y - storing 0 of 4
addi r14, r14, 72
jl r15, puti_func
subi r14, r14, 72
addi r1, r0, 8	% Start to calculate the offset for otherObject
...
add r1, r1, r2
sw 56(r14), r1
lw r1, 56(r14)	% Store the put value of otherObject.x - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 76(r14), r1	% Store the put value of otherObject.x - storing 0 of 4
addi r14, r14, 72
jl r15, puti_func
subi r14, r14, 72
addi r1, r0, 8	% Start to calculate the offset for otherObject
...
add r1, r1, r2
sw 64(r14), r1
lw r1, 64(r14)	% Store the put value of otherObject.y - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 76(r14), r1	% Store the put value of otherObject.y - storing 0 of 4
addi r14, r14, 72
jl r15, puti_func
subi r14, r14, 72
hlt
