...
geti_save	mul r1, r1, r6	% Make sure the sign is correct.
			...
			jr r15
entry
addi r14, r0, 2308  % Set the stack pointer
...
addi r1, r0, 0	% Storing 0
sb 167(r14), r1
lw r1, 164(r14)	% int i = 0 - loading 0 of 4
sw 160(r14), r1	% int i = 0 - storing 0 of 4
j forcond_23_5
for_23_5    nop	% Start the for loop
addi r1, r0, 160	% Start to calculate the offset for i
sw 168(r14), r1
...
addi r1, r0, 0	% Storing 0
sb 175(r14), r1
lw r2, 168(r14)	% Loading the value of i
lw r2, 0(r2)	% Pointer detected. Dereferencing i
lw r3, 172(r14)	% Loading the value of 1
add r1, r2, r3	% Calculating (i + 1)
sw 176(r14), r1
lw r1, 176(r14)	% i=(i + 1) - loading 0 of 4
lw r2, 168(r14)
...
lw r2, 168(r14)	% Loading the value of i
lw r2, 0(r2)	% Pointer detected. Dereferencing i
lw r3, 180(r14)	% Loading the value of 10
clt r1, r2, r3	% Evaluate (i < 10)
sw 184(r14), r1
lw r1, 184(r14)	% Loading the value of (i < 10)
bz r1, endfor_23_5
addi r1, r0, 160	% Start to calculate the offset for i
sw 168(r14), r1
addi r1, r14, 0	% Calculating the REAL offset for i
...
add r1, r1, r2
sw 168(r14), r1
addi r1, r0, 0	% Start to calculate the offset for foo[i]
lw r2, 168(r14)	% Getting the index [i]
...
add r1, r1, r2
sw 168(r14), r1
lw r1, 168(r14)	% foo[i].x=i - loading 0 of 4
...
sw 232(r14), r1
lw r1, 232(r14)	% foo[i].element.y=(i * 10) - loading 0 of 4
lw r2, 228(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
addi r1, r0, 160	% Start to calculate the offset for i
sw 168(r14), r1
...
lw r2, 168(r14)	% Loading the value of i
lw r2, 0(r2)	% Pointer detected. Dereferencing i
lw r3, 244(r14)	% Loading the value of 100
mul r1, r2, r3	% Calculating (i * 100)
sw 248(r14), r1
lw r1, 248(r14)	% foo[i].element.z=(i * 100) - loading 0 of 4
lw r2, 240(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
addi r1, r0, 160	% Start to calculate the offset for i
sw 168(r14), r1
...
lw r2, 168(r14)	% Loading the value of i
lw r2, 0(r2)	% Pointer detected. Dereferencing i
lw r3, 264(r14)	% Loading the value of 1000
mul r1, r2, r3	% Calculating (i * 1000)
sw 268(r14), r1
lw r1, 268(r14)	% foo[i].element.other.val=(i * 1000) - loading 0 of 4
lw r2, 260(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
j for_23_5
endfor_23_5    nop
...
add r1, r1, r2
sw 208(r14), r1
lw r1, 208(r14)	% Store the put value of foo[i].x - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 276(r14), r1	% Store the put value of foo[i].x - storing 0 of 4
addi r14, r14, 272
jl r15, puti_func
subi r14, r14, 272
addi r1, r0, 160	% Start to calculate the offset for i
...
add r1, r1, r2
sw 228(r14), r1
lw r1, 228(r14)	% Store the put value of foo[i].element.y - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 276(r14), r1	% Store the put value of foo[i].element.y - storing 0 of 4
addi r14, r14, 272
jl r15, puti_func
subi r14, r14, 272
addi r1, r0, 160	% Start to calculate the offset for i
...
add r1, r1, r2
sw 240(r14), r1
lw r1, 240(r14)	% Store the put value of foo[i].element.z - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 276(r14), r1	% Store the put value of foo[i].element.z - storing 0 of 4
addi r14, r14, 272
jl r15, puti_func
subi r14, r14, 272
addi r1, r0, 160	% Start to calculate the offset for i
...
add r1, r1, r2
sw 260(r14), r1
lw r1, 260(r14)	% Store the put value of foo[i].element.other.val - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 276(r14), r1	% Store the put value of foo[i].element.other.val - storing 0 of 4
addi r14, r14, 272
jl r15, puti_func
subi r14, r14, 272
j for_30_5
