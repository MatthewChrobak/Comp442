...
geti_save	mul r1, r1, r6	% Make sure the sign is correct.
			...
			jr r15
entry
addi r14, r0, 564  % Set the stack pointer
...
sw 28(r14), r1	% Store the put value of x - storing 0 of 4
addi r14, r14, 24
jl r15, puti_func
subi r14, r14, 24
addi r1, r0, 4	% Start to calculate the offset for y
...
addi r1, r1, 4
sw 20(r14), r1
lw r1, 16(r14)	% Store the put value of y - loading 0 of 8
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 28(r14), r1	% Store the put value of y - storing 0 of 8
lw r1, 20(r14)	% Store the put value of y - loading 4 of 8
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 32(r14), r1	% Store the put value of y - storing 4 of 8
addi r14, r14, 24
jl r15, putf_func
subi r14, r14, 24
hlt
