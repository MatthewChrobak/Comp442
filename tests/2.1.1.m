...
add r1, r1, r2
sw 16(r14), r1
lw r1, 16(r14)	% Store the put value of x - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 36(r14), r1	% Store the put value of x - storing 0 of 4
addi r14, r14, 32
jl r15, puti_func
subi r14, r14, 32
addi r1, r0, 12	% Start to calculate the offset for y
...
add r1, r1, r2
sw 24(r14), r1
lw r1, 24(r14)	% Store the put value of y - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 36(r14), r1	% Store the put value of y - storing 0 of 4
addi r14, r14, 32
jl r15, puti_func
subi r14, r14, 32
...
jr r15
entry
addi r14, r0, 664  % Set the stack pointer
