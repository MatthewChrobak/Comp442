...
geti_save	mul r1, r1, r6	% Make sure the sign is correct.
			...
			jr r15
entry
addi r14, r0, 2112  % Set the stack pointer
...
addi r1, r0, 0	% Storing 0
sb 4063(r14), r1
lw r1, 4060(r14)	% int i = 0 - loading 0 of 4
sw 4044(r14), r1	% int i = 0 - storing 0 of 4
j forcond_7_5
for_7_5    nop	% Start the for loop
addi r1, r0, 4044	% Start to calculate the offset for i
sw 4064(r14), r1
...
addi r1, r0, 0	% Storing 0
sb 4071(r14), r1
lw r2, 4064(r14)	% Loading the value of i
lw r2, 0(r2)	% Pointer detected. Dereferencing i
lw r3, 4068(r14)	% Loading the value of 1
add r1, r2, r3	% Calculating (i + 1)
sw 4072(r14), r1
lw r1, 4072(r14)	% i=(i + 1) - loading 0 of 4
lw r2, 4064(r14)
...
lw r2, 4064(r14)	% Loading the value of i
lw r2, 0(r2)	% Pointer detected. Dereferencing i
lw r3, 4076(r14)	% Loading the value of 10
clt r1, r2, r3	% Evaluate (i < 10)
sw 4080(r14), r1
lw r1, 4080(r14)	% Loading the value of (i < 10)
bz r1, endfor_7_5
addi r1, r0, 4044	% Start to calculate the offset for i
sw 4064(r14), r1
addi r1, r14, 0	% Calculating the REAL offset for i
...
add r1, r1, r2
sw 4064(r14), r1
addi r1, r0, 0	% Start to calculate the offset for array[i]
lw r2, 4064(r14)	% Getting the index [i]
...
add r1, r1, r2
sw 4064(r14), r1
lw r1, 4064(r14)	% array[i]=i - loading 0 of 4
...
add r1, r1, r2
sw 4084(r14), r1
lw r1, 4084(r14)	% Store the put value of array[i] - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 4148(r14), r1	% Store the put value of array[i] - storing 0 of 4
addi r14, r14, 4144
jl r15, puti_func
subi r14, r14, 4144
j for_7_5
endfor_7_5    nop
addi r1, r0, 4040	% Start to calculate the offset for num
sw 4088(r14), r1
...
addi r1, r0, 0	% Storing 0
sb 4063(r14), r1
lw r1, 4060(r14)	% num=0 - loading 0 of 4
lw r2, 4088(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
addi r1, r0, 0	% Storing 0
sb 4060(r14), r1
...
addi r1, r0, 0	% Storing 0
sb 4063(r14), r1
lw r1, 4060(r14)	% int x = 0 - loading 0 of 4
sw 4048(r14), r1	% int x = 0 - storing 0 of 4
j forcond_14_5
for_14_5    nop	% Start the for loop
addi r1, r0, 4048	% Start to calculate the offset for x
sw 4092(r14), r1
...
addi r1, r0, 0	% Storing 0
sb 4071(r14), r1
lw r2, 4092(r14)	% Loading the value of x
lw r2, 0(r2)	% Pointer detected. Dereferencing x
lw r3, 4068(r14)	% Loading the value of 1
add r1, r2, r3	% Calculating (x + 1)
sw 4096(r14), r1
lw r1, 4096(r14)	% x=(x + 1) - loading 0 of 4
lw r2, 4092(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
forcond_14_5   nop
addi r1, r0, 4048	% Start to calculate the offset for x
...
lw r2, 4092(r14)	% Loading the value of x
lw r2, 0(r2)	% Pointer detected. Dereferencing x
lw r3, 4100(r14)	% Loading the value of 5
clt r1, r2, r3	% Evaluate (x < 5)
sw 4104(r14), r1
lw r1, 4104(r14)	% Loading the value of (x < 5)
bz r1, endfor_14_5
addi r1, r0, 0	% Storing 0
sb 4060(r14), r1
addi r1, r0, 0	% Storing 0
...
addi r1, r0, 0	% Storing 0
sb 4063(r14), r1
lw r1, 4060(r14)	% int y = 0 - loading 0 of 4
sw 4052(r14), r1	% int y = 0 - storing 0 of 4
j forcond_15_9
for_15_9    nop	% Start the for loop
addi r1, r0, 4052	% Start to calculate the offset for y
sw 4108(r14), r1
...
addi r1, r0, 0	% Storing 0
sb 4071(r14), r1
lw r2, 4108(r14)	% Loading the value of y
lw r2, 0(r2)	% Pointer detected. Dereferencing y
lw r3, 4068(r14)	% Loading the value of 1
add r1, r2, r3	% Calculating (y + 1)
sw 4112(r14), r1
lw r1, 4112(r14)	% y=(y + 1) - loading 0 of 4
lw r2, 4108(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
forcond_15_9   nop
addi r1, r0, 4052	% Start to calculate the offset for y
...
sw 4116(r14), r1
lw r1, 4116(r14)	% Loading the value of (y < 10)
bz r1, endfor_15_9
addi r1, r0, 0	% Storing 0
sb 4060(r14), r1
addi r1, r0, 0	% Storing 0
...
addi r1, r0, 0	% Storing 0
sb 4063(r14), r1
lw r1, 4060(r14)	% int z = 0 - loading 0 of 4
sw 4056(r14), r1	% int z = 0 - storing 0 of 4
j forcond_16_13
for_16_13    nop	% Start the for loop
addi r1, r0, 4056	% Start to calculate the offset for z
sw 4120(r14), r1
...
addi r1, r0, 0	% Storing 0
sb 4071(r14), r1
lw r2, 4120(r14)	% Loading the value of z
lw r2, 0(r2)	% Pointer detected. Dereferencing z
lw r3, 4068(r14)	% Loading the value of 1
add r1, r2, r3	% Calculating (z + 1)
sw 4124(r14), r1
lw r1, 4124(r14)	% z=(z + 1) - loading 0 of 4
lw r2, 4120(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
forcond_16_13   nop
addi r1, r0, 4056	% Start to calculate the offset for z
...
lw r2, 4120(r14)	% Loading the value of z
lw r2, 0(r2)	% Pointer detected. Dereferencing z
lw r3, 4128(r14)	% Loading the value of 20
clt r1, r2, r3	% Evaluate (z < 20)
sw 4132(r14), r1
lw r1, 4132(r14)	% Loading the value of (z < 20)
bz r1, endfor_16_13
addi r1, r0, 4048	% Start to calculate the offset for x
sw 4092(r14), r1
addi r1, r14, 0	% Calculating the REAL offset for x
...
add r1, r1, r2
sw 4120(r14), r1
addi r1, r0, 40	% Start to calculate the offset for multiArray[x][y][z]
lw r2, 4092(r14)	% Getting the index [x]
lw r2, 0(r2)	% Pointer deteced - dereferencing
muli r2, r2, 4	% Multiply by the size.
muli r2, r2, 10	% Multiply by the chunk size 10
muli r2, r2, 20	% Multiply by the chunk size 20
add r1, r1, r2	% Add the index x
lw r2, 4108(r14)	% Getting the index [y]
lw r2, 0(r2)	% Pointer deteced - dereferencing
muli r2, r2, 4	% Multiply by the size.
muli r2, r2, 20	% Multiply by the chunk size 20
add r1, r1, r2	% Add the index y
lw r2, 4120(r14)	% Getting the index [z]
lw r2, 0(r2)	% Pointer deteced - dereferencing
muli r2, r2, 4	% Multiply by the size.
...
add r1, r1, r2
sw 4088(r14), r1
lw r1, 4088(r14)	% multiArray[x][y][z]=num - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
lw r2, 4136(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
addi r1, r0, 4040	% Start to calculate the offset for num
...
addi r1, r0, 0	% Storing 0
sb 4071(r14), r1
lw r2, 4088(r14)	% Loading the value of num
lw r2, 0(r2)	% Pointer detected. Dereferencing num
lw r3, 4068(r14)	% Loading the value of 1
add r1, r2, r3	% Calculating (num + 1)
sw 4140(r14), r1
lw r1, 4140(r14)	% num=(num + 1) - loading 0 of 4
lw r2, 4088(r14)
sw 0(r2), r1	% Pointer detected. Storing the value in the dereferenced location.
addi r1, r0, 4048	% Start to calculate the offset for x
sw 4092(r14), r1
...
add r1, r1, r2
sw 4136(r14), r1
lw r1, 4136(r14)	% Store the put value of multiArray[x][y][z] - loading 0 of 4
lw r1, 0(r1)	% Pointer detected. Dereferencing.
sw 4148(r14), r1	% Store the put value of multiArray[x][y][z] - storing 0 of 4
addi r14, r14, 4144
jl r15, puti_func
subi r14, r14, 4144
j for_16_13
